<template>
    <v-card>
        ...
        <v-card-text>
            ...
            <v-btn block color="primary" class="my-2" @click="showDialog = true" :disabled="!cart.length">
                Обновить
            </v-btn>
            <v-text-field
                class="mt-2"
                ...
                <template v-slot:item.variants="{item}">
                    <v-list>
                        <v-list-item>
                            <v-list-item-content>
                                <v-list-item-title>
                                    <v-icon v-if="item.is_iherb" color="success">
                                        mdi-check
                                    </v-icon>
                                ...
                                <v-list-item-subtitle>IHerb</v-list-item-subtitle>
                            </v-list-item-content>
                        </v-list-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-list-item-title>
                                    <v-icon v-if="item.is_dubai" color="success">
                                        mdi-check
                                    </v-icon>
                                    <v-icon v-else color="error">
                                        mdi-close
                                ...
                                <v-list-item-subtitle>Дубай</v-list-item-subtitle>
                            </v-list-item-content>
                        </v-list-item>
                    </v-list>
                </template>
        ...
        <v-dialog max-width="600" v-model="showDialog">
            <v-card>
                <v-card-title class="headline d-flex justify-space-between">
                    <span class="white--text">Обновить товары</span>
...
export default {
    ...
    methods: {
        async onSubmit () {
            ...
            this.$loading.enable();
            await axiosClient.post(`/v2/products/mass-iherb`, {
    ...
    computed: {
        ...
        products() {
            ...
            if (this.isDubai) {
                products = products.filter(p => p.is_dubai);
            }
