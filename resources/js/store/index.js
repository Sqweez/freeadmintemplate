    ...
    actions: {
        async INIT({ dispatch }) {
            ...
            await Promise.all([
                ...
                dispatch(ACTIONS.GET_STORE_TYPES),
                dispatch(ACTIONS.GET_USERS),
                dispatch(ACTIONS.GET_USER_ROLES),
                dispatch(ACTIONS.GET_CITIES),
                dispatch(ACTIONS.GET_LOYALTY),
                dispatch(ACTIONS.GET_SALE_TYPES),
                dispatch(ACTIONS.GET_WHOLESALE_TYPES),
                dispatch(ACTIONS.GET_MARGIN_TYPES),
                dispatch(ACTIONS.GET_CURRENCIES),
            ]);
