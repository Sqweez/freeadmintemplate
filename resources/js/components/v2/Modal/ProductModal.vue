        ...
        <v-card>
            ...
            <v-card-text>
                <v-form v-if="SHOW_MODAL">
                    ...
                    <div>
                        ...
                        <p>
                           Общая фотография для группы товаров, будет отображаться в каталоге по умолчания, и внутри товара, в случае, если не загружены вариативные
                        </p>
                    </div>
                    <div v-if="!isEditing">
                        ...
                        <p>
                           Вариативные фотографии для ассортимента товара, например разные цвета упаковки для батончиков разных вкусов
                        </p>
                    </div>
            ...
            <v-card-actions>
                ...
                <v-progress-circular
                    ...
                    color="primary"
                ></v-progress-circular>
                <v-btn color="success" text @click="onSubmit" v-else>{{ getButtonText }}<v-icon>mdi-check</v-icon></v-btn>
            </v-card-actions>
        </v-card>
        <ManufacturerModal
