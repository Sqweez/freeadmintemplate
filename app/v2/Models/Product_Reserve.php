...
/*class Product extends Model
{
    ...
    {
        return $this->belongsTo('App\v2\Product', 'group_id');
    }

    public function children()
    {
        return $this->hasMany('App\v2\Product', 'group_id', 'group_id');
    }
    ...
    public function attributes() {
        return $this->belongsToMany('App\v2\Models\AttributeValue', 'product_attributes');
    }
